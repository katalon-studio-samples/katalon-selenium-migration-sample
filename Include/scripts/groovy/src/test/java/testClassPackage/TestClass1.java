...
import src.test.java.pageObjectsPackage.AddExpensesPage;
import src.test.java.pageObjectsPackage.ListCategoryPage;
import src.test.java.pageObjectsPackage.ListExpensesPage;
import src.test.java.pageObjectsPackage.LoginPage;
import src.test.java.pageObjectsPackage.EditUserAccount;
...
public class TestClass1 {
	...
	public void SetUp() {
		...
		System.setProperty("webdriver.gecko.driver", DriverFactory.getChromeDriverPath());
